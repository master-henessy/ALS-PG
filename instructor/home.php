...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <div class="content-wrapper"  id="showpage" style="width: 84%">
    <div class="container-fluid">
      ...
      <?php
    $query=mysqli_query($conn,"select COUNT(*) as count from reminders")or die(mysqli_error($conn));
      $row=mysqli_fetch_array($query);
        $count1=$row['count'];

            $query2=mysqli_query($conn,"select COUNT(*) as count from events")or die(mysqli_error($conn));
