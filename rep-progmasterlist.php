...
// Arial bold 15
	...
	$pdf->Cell(40);
	$pdf->SetFont('Arial','B',12);
	$pdf->Cell(10.00,5,'Section:',0,0,'L');
	$pdf->Cell(10);
	$pdf->SetFont('Arial','B',12);
	$pdf->Cell(10.00,5,'All Sections',0,0,'L');
	$pdf->Cell(35);
	$pdf->SetFont('Arial','B',12);
	...
	$pdf->Ln(5);
	$sql=mysqli_query($conn,"select * from students where sy='$sy' AND program='$program'")or die(mysqli_error($conn));
