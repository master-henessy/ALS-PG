...
?>                      
                    ...
                    <a href="student-edit.php?id=<?php echo $id;?>" class="btn btn-danger" >
                      <i class="fa fa-pencil"></i>
                      <span class="nav-link-text">Edit</span>
                      <span class="nav-link-text"></span>
                    </a>

                    <a href="student-delete.php?id=<?php echo $id;?>" class="btn btn-danger" >
                      <i class="fa fa-trash"></i>
                      <span class="nav-link-text">Delete</span>
                      <span class="nav-link-text"></span>
                    </a>
                     <a href="<?php echo $reqfile;?>" class="btn btn-danger" >
                      <i class="fa fa-eye"></i>
                    ...
                    <div class="form-group">
                      <label for="exampleInputPassword1">Student Requirements:</label><br>
